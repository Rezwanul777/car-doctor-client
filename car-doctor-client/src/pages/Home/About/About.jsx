...
const About = () => {
  ...
  <div className="hero-content flex-col lg:flex-row">
        ...
        <img src={person} className="w-3/4 h-[420px] rounded-lg shadow-2xl" />
        <img src={parts} className="w-1/2 h-[250px]  absolute right-6 top-1/2 border-8 border-white rounded-lg shadow-2xl" />
        </div>
